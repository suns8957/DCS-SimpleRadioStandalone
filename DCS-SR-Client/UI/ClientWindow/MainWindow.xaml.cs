...
public partial class MainWindow : MetroWindow
{
    ...
    // private AwacsRadioOverlayWindow.AwaRadioOverlayWindow _awacsAwaRadioOverlay;
    ...
    //
    //         if (_awacsAwaRadioOverlay != null)
    //         {
    //             _awacsAwaRadioOverlay.Left = 300;
    //             _awacsAwaRadioOverlay.Top = 300;
    //         }
    //     }
    // }
    //
    ...
    // {
    //     InputManager = InputDeviceManager.Instance;
    //
    //     InitSettingsProfiles();
    //
    ...
    //
    //     _awacsAwaRadioOverlay?.Close();
    //     _awacsAwaRadioOverlay = null;
    //
    ...
    //
    //         bool eamEnabled = _serverSettings.GetSettingAsBool(ServerSettingsKeys.EXTERNAL_AWACS_MODE);
    //
    ...
    // {
    //     if (_awacsAwaRadioOverlay == null || !_awacsAwaRadioOverlay.IsVisible ||
    //         _awacsAwaRadioOverlay.WindowState == WindowState.Minimized)
    //     {
    ...
    //         _awacsAwaRadioOverlay?.Close();
    //
    //         _awacsAwaRadioOverlay = new AwacsRadioOverlayWindow.AwaRadioOverlayWindow();
    //         _awacsAwaRadioOverlay.ShowInTaskbar =
    //             !_globalSettings.GetClientSettingBool(GlobalSettingsKeys.RadioOverlayTaskbarHide);
    //         _awacsAwaRadioOverlay.Show();
    //     }
    //     else
    //     {
    //         _awacsAwaRadioOverlay?.Close();
    ...
    //         _radioOverlayWindow.ShowInTaskbar =
    //             !_globalSettings.GetClientSettingBool(GlobalSettingsKeys.RadioOverlayTaskbarHide);
    //     else if (_awacsAwaRadioOverlay != null)
    //         _awacsAwaRadioOverlay.ShowInTaskbar =
    //             !_globalSettings.GetClientSettingBool(GlobalSettingsKeys.RadioOverlayTaskbarHide);
    // }
    //
    ...
    public MainWindow()
    {
        ...
        FavouriteServersView.DataContext = new FavouriteServersViewModel(new CsvFavouriteServerStore());
    }
