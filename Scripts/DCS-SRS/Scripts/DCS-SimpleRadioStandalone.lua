...
function SR.exportRadioMiG29Fulcrum(_data)
...
SR.exporters["MiG-29 Fulcrum"] = SR.exportRadioMiG29Fulcrum
...
SR.log("Loaded SimpleRadio Standalone Export version: 2.3.1.0")
