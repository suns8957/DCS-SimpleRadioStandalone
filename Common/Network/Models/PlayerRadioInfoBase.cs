...
public class PlayerRadioInfoBase
{
    ...
    public RadioBase[] radios = new RadioBase[11]; //10 + intercom
    ...
    {
        for (var i = 0; i < 11; i++) radios[i] = new RadioBase();
    }
    ...
    public PlayerRadioInfoBase DeepClone()
    {
        ...
        //ignore position
        clone.radios = new RadioBase[11];

        for (var i = 0; i < 11; i++) clone.radios[i] = radios[i].DeepClone();
